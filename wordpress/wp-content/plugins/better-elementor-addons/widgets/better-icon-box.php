...
class Better_Icon_Box extends Widget_Base {
	...
	public function get_title() {
		return __( 'BETTER Icon Box','better-widgets' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'1' => __( 'Style One', 'better-widgets' ),
					'2' => __( 'Style Two', 'better-widgets' ),
					'3' => __( 'Style Three', 'better-widgets' ),
					'4' => __( 'Style Four', 'better-widgets' ),
				],
				'default' => '1',
			]
		);
		...
		$this->add_control(
			'icon_style',
			[
				'label' => __( 'Text & Icon  Type','better-widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'center' => __( 'Centered Icon','better-widgets' ),
					'left' => __( 'Left Aligned Icon','better-widgets' ),
		...
		$this->add_responsive_control(
			'title_text_margin',
			[
				'label' => __( 'Title & Subtitle Spacing','better-widgets' ),
		...
		$this->start_controls_section(
			'box_settings',
			[
				'label' => __( 'Box Setting','better-widgets' ),
		...
		$this->start_controls_tab(
			'tab_box_normal',
			[
				'label' => __( 'Normal', 'better-widgets' ),
			]
		);
		...
		$this->start_controls_section(
			'title_settings',
			[
				'label' => __( 'Title Setting','better-widgets' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'subtitle_settings',
			[
				'label' => __( 'Subtitle Setting','better-widgets' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Subtitle Typography', 'better-widgets' ),
		...
		$this->start_controls_section(
			'text_settings',
			[
				'label' => __( 'Text Setting','better-widgets' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'icon_settings',
			[
				'label' => __( 'Icon Setting','better-widgets' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'icon_height',
			[
				'label' => __( 'Icon height','better-widgets' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 6,
		...
		$this->add_responsive_control(
			'icon_bg_size',
			[
				'label' => __( 'Background Size','better-widgets' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 6,
	...
	protected function render() {
		...
		<div class="better box-with-icon <?php if  ($settings['feature_style'] == '1') {echo "feature-1"; }elseif  ($settings['feature_style'] == '2') {echo "feature-2"; }elseif  ($settings['feature_style'] == '3') {echo "feature-3"; }else{echo "feature-4"; }?>">
