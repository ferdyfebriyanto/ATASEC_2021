 ...
 * @since 1.0.0
 */
class Canteen_Post_Three extends Widget_Base {
	...
	public function get_title() {
		return __( 'Canteen Post List Style 3', 'canteen-essential' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'style1' => __( 'Style One', 'canteen-essential' ),
					'style2' => __( 'Style Two', 'canteen-essential' ),
				],
				'default' => 'style1',
			]
		);
		...
		$this->add_control(
			'meta_button_show',
			[
				'label' => __( 'Show Meta Button', 'canteen-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'label_on' => __( 'Show', 'canteen-essential' ),
				'label_off' => __( 'Hide', 'canteen-essential' ),
		...
		$this->add_control(
			'cat_show',
			[
				'label' => __( 'Show Post Tags', 'canteen-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_on' => __( 'Show', 'canteen-essential' ),
				'label_off' => __( 'Hide', 'canteen-essential' ),
		...
		$this->add_control(
			'tag_icon',
			[
				'label' => __( 'Tag Icon', 'canteen-essential' ),
				'type' => Controls_Manager::ICON,
				'label_block' => true,
				'default' => 'fa fa-tag',
				'condition' => [
		...
		$this->start_controls_section(
			'post_section',
			[
				'label' => __( 'Post Settings', 'canteen-essential' ),
		...
		$this->add_responsive_control(
			'post_margin',
			[
				'label' => __( 'Post Margin', 'canteen-essential' ),
