                          ...
                          <?php if ( $item['btn_link2'] && $item['btn_text2']){ ?>
                              <div class="btn-relative" data-animation="swashIn" data-delay="1.8s" data-animation-duration="1s">
                                <?php if ( ! empty( $item['btn_link2']['url'] ) ) {
									...
									$attr  = 'href="' . $item['btn_link2']['url'] . '"';
									$attr .= !empty( $item['btn_link2']['is_external'] ) ? ' target="_blank"' : '';
									$attr .= !empty( $item['btn_link2']['nofollow'] ) ? ' rel="nofollow"' : '';
									echo '<a class="slider-btn dsc-btn-style2" ' .$attr. '>';
