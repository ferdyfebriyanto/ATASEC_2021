(function($) {
    ...
    $("#elementor-preview-iframe").on("load", function() {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/canteen-mason-gallery.default', function($scope) {
			 $scope.find('.mason-gallery').imagesLoaded(function() { 
			 	$scope.find('.mason-gallery').isotope();
			 });
		});
		elementorFrontend.hooks.addAction('frontend/element_ready/canteen-post-four.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/canteen-testimonial.default', function($scope) {
        ...
        //for img-box slider
        elementorFrontend.hooks.addAction('frontend/element_ready/canteen-image-box-slider.default', function($scope) {
        ...
        //for img-box slider
        elementorFrontend.hooks.addAction('frontend/element_ready/canteen-work-process.default', function($scope) {
		...
		//for post slider
        elementorFrontend.hooks.addAction('frontend/element_ready/canteen-post-slider.default', function($scope) {
        ...
        //for menu
        elementorFrontend.hooks.addAction('frontend/element_ready/canteen-menu.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/canteen-portfolio-info.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/canteen-portfolio.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/canteen-portfolio-masonry.default', function($scope) {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/canteen-sidebar.default', function($scope) {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/canteen-texticon-hover.default', function($scope) {
			$scope.find('.box-padding').each(function() {
				$(this).closest('.elementor-column-wrap').addClass('hovering');
			});
		});
		
		elementorFrontend.hooks.addAction('frontend/element_ready/canteen-team-hover.default', function($scope) {
			$scope.find('.box-padding').each(function() {
				$(this).closest('.elementor-column-wrap').addClass('hovering');
			});
		});
