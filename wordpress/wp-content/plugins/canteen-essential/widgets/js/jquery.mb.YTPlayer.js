	...
	jQuery.mbYTPlayer = {
		...
		buildPlayer: function( options ) {
			return this.each( function() {
				...
				YTPlayer.filtersEnabcanteen = true;
		...
		applyFilter: function( filter, value ) {
			return this.each( function() {
				...
				if( YTPlayer.filtersEnabcanteen )
		...
		toggleFilter: function( filter, value ) {
			return this.each( function() {
				...
				if( YTPlayer.filtersEnabcanteen ) jQuery( this ).YTPEnableFilters();
			} );
		},
		...
		toggleFilters: function( callback ) {
			return this.each( function() {
				...
				if( typeof callback == "function" )
					callback( YTPlayer.filtersEnabcanteen );
			} )
		},
		...
		disableFilters: function() {
			return this.each( function() {
				...
				iframe.css( "filter", "" );
				YTPlayer.filtersEnabcanteen = false;
			} )
		},
